...
LISTITEM binary_box_s[256] =
    {
        {"\x20", 0x00, NULL, NULL, NULL},
        {"\x01", 0x01, NULL, NULL, NULL},
        {"\x02", 0x02, NULL, NULL, NULL},
        {"\x03", 0x03, NULL, NULL, NULL},
        {"\x04", 0x04, NULL, NULL, NULL},
        {"\x05", 0x05, NULL, NULL, NULL},
        {"\x06", 0x06, NULL, NULL, NULL},
        {"\x07", 0x07, NULL, NULL, NULL},
        {"\x08", 0x08, NULL, NULL, NULL},
        {"\x09", 0x09, NULL, NULL, NULL},
        {"\x0A", 0x0A, NULL, NULL, NULL},
        {"\x0B", 0x0B, NULL, NULL, NULL},
        {"\x0C", 0x0C, NULL, NULL, NULL},
        {"\x0D", 0x0D, NULL, NULL, NULL},
        {"\x0E", 0x0E, NULL, NULL, NULL},
        {"\x0F", 0x0F, NULL, NULL, NULL},

        {"\x10", 0x10, NULL, NULL, NULL},
        {"\x11", 0x11, NULL, NULL, NULL},
        {"\x12", 0x12, NULL, NULL, NULL},
        {"\x13", 0x13, NULL, NULL, NULL},
        {"\x14", 0x14, NULL, NULL, NULL},
        {"\x15", 0x15, NULL, NULL, NULL},
        {"\x16", 0x16, NULL, NULL, NULL},
        {"\x17", 0x17, NULL, NULL, NULL},
        {"\x18", 0x18, NULL, NULL, NULL},
        {"\x19", 0x19, NULL, NULL, NULL},
        {"\x1A", 0x1A, NULL, NULL, NULL},
        {"\x1B", 0x1B, NULL, NULL, NULL},
        {"\x1C", 0x1C, NULL, NULL, NULL},
        {"\x1D", 0x1D, NULL, NULL, NULL},
        {"\x1E", 0x1E, NULL, NULL, NULL},
        {"\x1F", 0x1F, NULL, NULL, NULL},

        {"\x20", 0x20, NULL, NULL, NULL},
        {"\x21", 0x21, NULL, NULL, NULL},
        {"\x22", 0x22, NULL, NULL, NULL},
        {"\x23", 0x23, NULL, NULL, NULL},
        {"\x24", 0x24, NULL, NULL, NULL},
        {"\x25", 0x25, NULL, NULL, NULL},
        {"\x26", 0x26, NULL, NULL, NULL},
        {"\x27", 0x27, NULL, NULL, NULL},
        {"\x28", 0x28, NULL, NULL, NULL},
        {"\x29", 0x29, NULL, NULL, NULL},
        {"\x2A", 0x2A, NULL, NULL, NULL},
        {"\x2B", 0x2B, NULL, NULL, NULL},
        {"\x2C", 0x2C, NULL, NULL, NULL},
        {"\x2D", 0x2D, NULL, NULL, NULL},
        {"\x2E", 0x2E, NULL, NULL, NULL},
        {"\x2F", 0x2F, NULL, NULL, NULL},

        {"\x30", 0x30, NULL, NULL, NULL},
        {"\x31", 0x31, NULL, NULL, NULL},
        {"\x32", 0x32, NULL, NULL, NULL},
        {"\x33", 0x33, NULL, NULL, NULL},
        {"\x34", 0x34, NULL, NULL, NULL},
        {"\x35", 0x35, NULL, NULL, NULL},
        {"\x36", 0x36, NULL, NULL, NULL},
        {"\x37", 0x37, NULL, NULL, NULL},
        {"\x38", 0x38, NULL, NULL, NULL},
        {"\x39", 0x39, NULL, NULL, NULL},
        {"\x3A", 0x3A, NULL, NULL, NULL},
        {"\x3B", 0x3B, NULL, NULL, NULL},
        {"\x3C", 0x3C, NULL, NULL, NULL},
        {"\x3D", 0x3D, NULL, NULL, NULL},
        {"\x3E", 0x3E, NULL, NULL, NULL},
        {"\x3F", 0x3F, NULL, NULL, NULL},

        {"\x40", 0x40, NULL, NULL, NULL},
        {"\x41", 0x41, NULL, NULL, NULL},
        {"\x42", 0x42, NULL, NULL, NULL},
        {"\x43", 0x43, NULL, NULL, NULL},
        {"\x44", 0x44, NULL, NULL, NULL},
        {"\x45", 0x45, NULL, NULL, NULL},
        {"\x46", 0x46, NULL, NULL, NULL},
        {"\x47", 0x47, NULL, NULL, NULL},
        {"\x48", 0x48, NULL, NULL, NULL},
        {"\x49", 0x49, NULL, NULL, NULL},
        {"\x4A", 0x4A, NULL, NULL, NULL},
        {"\x4B", 0x4B, NULL, NULL, NULL},
        {"\x4C", 0x4C, NULL, NULL, NULL},
        {"\x4D", 0x4D, NULL, NULL, NULL},
        {"\x4E", 0x4E, NULL, NULL, NULL},
        {"\x4F", 0x4F, NULL, NULL, NULL},

        {"\x50", 0x50, NULL, NULL, NULL},
        {"\x51", 0x51, NULL, NULL, NULL},
        {"\x52", 0x52, NULL, NULL, NULL},
        {"\x53", 0x53, NULL, NULL, NULL},
        {"\x54", 0x54, NULL, NULL, NULL},
        {"\x55", 0x55, NULL, NULL, NULL},
        {"\x56", 0x56, NULL, NULL, NULL},
        {"\x57", 0x57, NULL, NULL, NULL},
        {"\x58", 0x58, NULL, NULL, NULL},
        {"\x59", 0x59, NULL, NULL, NULL},
        {"\x5A", 0x5A, NULL, NULL, NULL},
        {"\x5B", 0x5B, NULL, NULL, NULL},
        {"\x5C", 0x5C, NULL, NULL, NULL},
        {"\x5D", 0x5D, NULL, NULL, NULL},
        {"\x5E", 0x5E, NULL, NULL, NULL},
        {"\x5F", 0x5F, NULL, NULL, NULL},

        {"\x60", 0x60, NULL, NULL, NULL},
        {"\x61", 0x61, NULL, NULL, NULL},
        {"\x62", 0x62, NULL, NULL, NULL},
        {"\x63", 0x63, NULL, NULL, NULL},
        {"\x64", 0x64, NULL, NULL, NULL},
        {"\x65", 0x65, NULL, NULL, NULL},
        {"\x66", 0x66, NULL, NULL, NULL},
        {"\x67", 0x67, NULL, NULL, NULL},
        {"\x68", 0x68, NULL, NULL, NULL},
        {"\x69", 0x69, NULL, NULL, NULL},
        {"\x6A", 0x6A, NULL, NULL, NULL},
        {"\x6B", 0x6B, NULL, NULL, NULL},
        {"\x6C", 0x6C, NULL, NULL, NULL},
        {"\x6D", 0x6D, NULL, NULL, NULL},
        {"\x6E", 0x6E, NULL, NULL, NULL},
        {"\x6F", 0x6F, NULL, NULL, NULL},

        {"\x70", 0x70, NULL, NULL, NULL},
        {"\x71", 0x71, NULL, NULL, NULL},
        {"\x72", 0x72, NULL, NULL, NULL},
        {"\x73", 0x73, NULL, NULL, NULL},
        {"\x74", 0x74, NULL, NULL, NULL},
        {"\x75", 0x75, NULL, NULL, NULL},
        {"\x76", 0x76, NULL, NULL, NULL},
        {"\x77", 0x77, NULL, NULL, NULL},
        {"\x78", 0x78, NULL, NULL, NULL},
        {"\x79", 0x79, NULL, NULL, NULL},
        {"\x7A", 0x7A, NULL, NULL, NULL},
        {"\x7B", 0x7B, NULL, NULL, NULL},
        {"\x7C", 0x7C, NULL, NULL, NULL},
        {"\x7D", 0x7D, NULL, NULL, NULL},
        {"\x7E", 0x7E, NULL, NULL, NULL},
        {"\x7F", 0x7F, NULL, NULL, NULL},

        {"\x80", 0x80, NULL, NULL, NULL},
        {"\x81", 0x81, NULL, NULL, NULL},
        {"\x82", 0x82, NULL, NULL, NULL},
        {"\x83", 0x83, NULL, NULL, NULL},
        {"\x84", 0x84, NULL, NULL, NULL},
        {"\x85", 0x85, NULL, NULL, NULL},
        {"\x86", 0x86, NULL, NULL, NULL},
        {"\x87", 0x87, NULL, NULL, NULL},
        {"\x88", 0x88, NULL, NULL, NULL},
        {"\x89", 0x89, NULL, NULL, NULL},
        {"\x8A", 0x8A, NULL, NULL, NULL},
        {"\x8B", 0x8B, NULL, NULL, NULL},
        {"\x8C", 0x8C, NULL, NULL, NULL},
        {"\x8D", 0x8D, NULL, NULL, NULL},
        {"\x8E", 0x8E, NULL, NULL, NULL},
        {"\x8F", 0x8F, NULL, NULL, NULL},

        {"\x90", 0x90, NULL, NULL, NULL},
        {"\x91", 0x91, NULL, NULL, NULL},
        {"\x92", 0x92, NULL, NULL, NULL},
        {"\x93", 0x93, NULL, NULL, NULL},
        {"\x94", 0x94, NULL, NULL, NULL},
        {"\x95", 0x95, NULL, NULL, NULL},
        {"\x96", 0x96, NULL, NULL, NULL},
        {"\x97", 0x97, NULL, NULL, NULL},
        {"\x98", 0x98, NULL, NULL, NULL},
        {"\x99", 0x99, NULL, NULL, NULL},
        {"\x9A", 0x9A, NULL, NULL, NULL},
        {"\x9B", 0x9B, NULL, NULL, NULL},
        {"\x9C", 0x9C, NULL, NULL, NULL},
        {"\x9D", 0x9D, NULL, NULL, NULL},
        {"\x9E", 0x9E, NULL, NULL, NULL},
        {"\x9F", 0x9F, NULL, NULL, NULL},

        {"\xA0", 0xA0, NULL, NULL, NULL},
        {"\xA1", 0xA1, NULL, NULL, NULL},
        {"\xA2", 0xA2, NULL, NULL, NULL},
        {"\xA3", 0xA3, NULL, NULL, NULL},
        {"\xA4", 0xA4, NULL, NULL, NULL},
        {"\xA5", 0xA5, NULL, NULL, NULL},
        {"\xA6", 0xA6, NULL, NULL, NULL},
        {"\xA7", 0xA7, NULL, NULL, NULL},
        {"\xA8", 0xA8, NULL, NULL, NULL},
        {"\xA9", 0xA9, NULL, NULL, NULL},
        {"\xAA", 0xAA, NULL, NULL, NULL},
        {"\xAB", 0xAB, NULL, NULL, NULL},
        {"\xAC", 0xAC, NULL, NULL, NULL},
        {"\xAD", 0xAD, NULL, NULL, NULL},
        {"\xAE", 0xAE, NULL, NULL, NULL},
        {"\xAF", 0xAF, NULL, NULL, NULL},

        {"\xB0", 0xB0, NULL, NULL, NULL},
        {"\xB1", 0xB1, NULL, NULL, NULL},
        {"\xB2", 0xB2, NULL, NULL, NULL},
        {"\xB3", 0xB3, NULL, NULL, NULL},
        {"\xB4", 0xB4, NULL, NULL, NULL},
        {"\xB5", 0xB5, NULL, NULL, NULL},
        {"\xB6", 0xB6, NULL, NULL, NULL},
        {"\xB7", 0xB7, NULL, NULL, NULL},
        {"\xB8", 0xB8, NULL, NULL, NULL},
        {"\xB9", 0xB9, NULL, NULL, NULL},
        {"\xBA", 0xBA, NULL, NULL, NULL},
        {"\xBB", 0xBB, NULL, NULL, NULL},
        {"\xBC", 0xBC, NULL, NULL, NULL},
        {"\xBD", 0xBD, NULL, NULL, NULL},
        {"\xBE", 0xBE, NULL, NULL, NULL},
        {"\xBF", 0xBF, NULL, NULL, NULL},

        {"\xC0", 0xC0, NULL, NULL, NULL},
        {"\xC1", 0xC1, NULL, NULL, NULL},
        {"\xC2", 0xC2, NULL, NULL, NULL},
        {"\xC3", 0xC3, NULL, NULL, NULL},
        {"\xC4", 0xC4, NULL, NULL, NULL},
        {"\xC5", 0xC5, NULL, NULL, NULL},
        {"\xC6", 0xC6, NULL, NULL, NULL},
        {"\xC7", 0xC7, NULL, NULL, NULL},
        {"\xC8", 0xC8, NULL, NULL, NULL},
        {"\xC9", 0xC9, NULL, NULL, NULL},
        {"\xCA", 0xCA, NULL, NULL, NULL},
        {"\xCB", 0xCB, NULL, NULL, NULL},
        {"\xCC", 0xCC, NULL, NULL, NULL},
        {"\xCD", 0xCD, NULL, NULL, NULL},
        {"\xCE", 0xCE, NULL, NULL, NULL},
        {"\xCF", 0xCF, NULL, NULL, NULL},

        {"\xD0", 0xD0, NULL, NULL, NULL},
        {"\xD1", 0xD1, NULL, NULL, NULL},
        {"\xD2", 0xD2, NULL, NULL, NULL},
        {"\xD3", 0xD3, NULL, NULL, NULL},
        {"\xD4", 0xD4, NULL, NULL, NULL},
        {"\xD5", 0xD5, NULL, NULL, NULL},
        {"\xD6", 0xD6, NULL, NULL, NULL},
        {"\xD7", 0xD7, NULL, NULL, NULL},
        {"\xD8", 0xD8, NULL, NULL, NULL},
        {"\xD9", 0xD9, NULL, NULL, NULL},
        {"\xDA", 0xDA, NULL, NULL, NULL},
        {"\xDB", 0xDB, NULL, NULL, NULL},
        {"\xDC", 0xDC, NULL, NULL, NULL},
        {"\xDD", 0xDD, NULL, NULL, NULL},
        {"\xDE", 0xDE, NULL, NULL, NULL},
        {"\xDF", 0xDF, NULL, NULL, NULL},

        {"\xE0", 0xE0, NULL, NULL, NULL},
        {"\xE1", 0xE1, NULL, NULL, NULL},
        {"\xE2", 0xE2, NULL, NULL, NULL},
        {"\xE3", 0xE3, NULL, NULL, NULL},
        {"\xE4", 0xE4, NULL, NULL, NULL},
        {"\xE5", 0xE5, NULL, NULL, NULL},
        {"\xE6", 0xE6, NULL, NULL, NULL},
        {"\xE7", 0xE7, NULL, NULL, NULL},
        {"\xE8", 0xE8, NULL, NULL, NULL},
        {"\xE9", 0xE9, NULL, NULL, NULL},
        {"\xEA", 0xEA, NULL, NULL, NULL},
        {"\xEB", 0xEB, NULL, NULL, NULL},
        {"\xEC", 0xEC, NULL, NULL, NULL},
        {"\xED", 0xED, NULL, NULL, NULL},
        {"\xEE", 0xEE, NULL, NULL, NULL},
        {"\xEF", 0xEF, NULL, NULL, NULL},

        {"\xF0", 0xF0, NULL, NULL, NULL},
        {"\xF1", 0xF1, NULL, NULL, NULL},
        {"\xF2", 0xF2, NULL, NULL, NULL},
        {"\xF3", 0xF3, NULL, NULL, NULL},
        {"\xF4", 0xF4, NULL, NULL, NULL},
        {"\xF5", 0xF5, NULL, NULL, NULL},
        {"\xF6", 0xF6, NULL, NULL, NULL},
        {"\xF7", 0xF7, NULL, NULL, NULL},
        {"\xF8", 0xF8, NULL, NULL, NULL},
        {"\xF9", 0xF9, NULL, NULL, NULL},
        {"\xFA", 0xFA, NULL, NULL, NULL},
        {"\xFB", 0xFB, NULL, NULL, NULL},
        {"\xFC", 0xFC, NULL, NULL, NULL},
        {"\xFD", 0xFD, NULL, NULL, NULL},
        {"\xFE", 0xFE, NULL, NULL, NULL},
        {"\xFF", 0xFF, NULL, NULL, NULL},
};
